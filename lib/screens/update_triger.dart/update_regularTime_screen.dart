...
class UpdateRegularIntervalScreen extends StatelessWidget {
  const UpdateRegularIntervalScreen({super.key});
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                if (controller.hours.value != 12) {
                                  controller.updateHMS(controller.hours,
                                      controller.hours.value + 1);
                                }
                              },
                              child: const Icon(
